...
The objective is to support data-driven decision-making through structured data cleaning, SQL analysis, and interactive dashboard visualization.
...
3. Initial EDA performed using Pivot Tables
4. Cleaned CSV loaded into PostgreSQL
5. SQL queries used for KPI and analytical validation
6. Power BI dashboard created with interactive slicers
...
- Align marketing campaigns with peak sales months.
...
- superstore_analysis.sql → SQL script (ETL + Analysis)
- Business_Insight_Report.pdf → Final business summary
